      ...
      rounded-lg'>
        ...
        className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <div className="flex gap-3">
            <button type="submit" className="py-2 px-4 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-md">
              Save
            </button>
            <button type="button" onClick={() => navigate(-1)} className="py-2 px-4 border rounded-md">
              Cancel
            </button>
          </div>

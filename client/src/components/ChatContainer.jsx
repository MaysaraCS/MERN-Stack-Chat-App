                ...
                <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f5116f10f3cd28382ed02' ? 'flex-row-reverse' : '' }`}>
                    {msg.image ? (
                        ...
                        <p className={`p-2 max-w-[200px] md:text-sm font-light
                            rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId === '680f5116f10f3cd28382ed02' ? 'rounded-br-none' :'rounded-bl-none'}`}>{msg.text}</p>
                    )}
                    <div className="text-center text-xs">
                        <img src={msg.senderId === '680f5116f10f3cd28382ed02' ? assets.avatar_icon:assets.profile_martin} alt="" className='w-7
                        rounded-full'/>
